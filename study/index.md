...
[Pytorch 最全入门介绍，Pytorch入门看这一篇就够了 - 知乎](https://zhuanlan.zhihu.com/p/647001891)

[Pytorch geometric 中 SparseTensor所支持的稀疏矩阵存储方式——COO、CSR、CSC - 知乎](https://zhuanlan.zhihu.com/p/545101217)

[用 Bootstrap 进行参数估计大有可为 - 知乎](https://zhuanlan.zhihu.com/p/41099219)

[Bootstrap重采样进行参数估计 - 置信区间_bootstrap重采样法-CSDN博客](https://blog.csdn.net/qq_33934427/article/details/124030782)
...
[Convert a TensorFlow Model to OpenVINO™](https://docs.openvino.ai/latest/notebooks/101-tensorflow-to-openvino-with-output.html)

[Install OpenVINO™ Runtime on Linux from an Archive File](https://docs.openvino.ai/2022.3/openvino_docs_install_guides_installing_openvino_from_archive_linux.html#doxid-openvino-docs-install-guides-installing-openvino-from-archive-linux)
...
[机器学习入门](https://www.youtube.com/playlist?list=PLD3Xyx6ef38zHClQhz-a_Y4rNyotS6OUb)
...
[Wavy AI Research Foundation](https://medium.com/machine-learning-researcher)
...
[SMS垃圾邮件分类器](https://blog.csdn.net/weixin_26746401/article/details/108494742)
...
[(sklearn) 官方文档中文版](https://sklearn.apachecn.org/#/)

[scikit-learn Machine Learning in Python](https://scikit-learn.org/stable/index.html)

[sklearn 官方文档中文版（0.22.1）](https://sklearn123.com/)

[当sklearn与keras的完美结合，调参原来这么简单](https://cloud.tencent.com/developer/article/1447855)

[Computer Vision Matrices 你不能不知道的重要矩陣!](https://www.phototalks.idv.tw/academic/?p=527)
...
[特征匹配+单应性查找对象](https://www.bookstack.cn/read/opencv-doc-zh-4.0/docs-4.0.0-5.10-tutorial_py_feature_homography.md)
...
[用Python做科学计算](https://wizardforcel.gitbooks.io/hyry-studio-scipy/content/index.html)

[matplotlib 学习笔记(1)： figure](https://www.jianshu.com/p/3a9bdbe3f467)

[seaborn: statistical data visualization](https://seaborn.pydata.org/index.html)

[【Python】一小时带你掌握seaborn可视化](https://www.bilibili.com/video/BV1VX4y1F76x/?spm_id_from=333.788.recommend_more_video.4)
...
[Html5 学习交流](https://www.html5tricks.com/)  
...
[PHP 单引号与双引号的区别(总结)](https://blog.csdn.net/h330531987/article/details/69495452)

[Bootstrap 快速入门](https://v4.bootcss.com/docs/getting-started/introduction/)
...
[CSCI 4152/6509 — Natural Language Processing](https://web.cs.dal.ca/~vlado/csci6509/index.html)

[Speech and Language Processing (3rd ed. draft)](https://web.stanford.edu/~jurafsky/slp3/)

[Dive into Deep Learning](https://d2l.ai/)

[Perl 5.34 中文perlre-Perl正则表达式](https://runebook.dev/zh-CN/docs/perl/perlre)

[perlretut-Perl正则表达式教程](https://runebook.dev/zh-CN/docs/perl/perlretut)
...
[机器学习——降维、聚类、分类、回归](https://blog.csdn.net/qq_41938858/article/details/87560942)

[线性回归 – linear regression](https://easyai.tech/ai-definition/linear-regression/)

[如何判别模型的优劣？](https://www.cnblogs.com/jin-liang/p/9539622.html)
...
[TensorFlow中loss与val_loss、accuracy和val_accuracy含义](https://blog.csdn.net/qingfengxd1/article/details/107320580)

[使用early stopping解决神经网络过拟合问题](https://blog.csdn.net/u010960155/article/details/104289173)

[一文详解高斯混合模型原理](https://zhuanlan.zhihu.com/p/31103654)

[概率统计知识点全解析（适合大一学习、考研复习基础）](https://www.bilibili.com/video/BV1D741147G5?p=2)

[【科普】+ 贝叶斯定理](https://www.bilibili.com/video/BV1HW411F7fy?from=search&seid=303105202109040757)

[【概率论】讲的最好的贝叶斯公式](https://www.bilibili.com/video/BV1RW411k7bx/?spm_id_from=333.788.recommend_more_video.-1)

[秒懂全概率公式，谁信？！你还记得贝叶斯吗?](https://www.bilibili.com/video/BV19D4y1X7Qn/?spm_id_from=333.788.recommend_more_video.3)

[十分钟理解正态分布及其应用](https://www.bilibili.com/video/BV1av411W7g3)

[高斯混合模型](https://www.bilibili.com/video/BV124411g7AL?p=2&spm_id_from=pageDriver)

[第七课 朴素贝叶斯分类器案例实战](https://www.youtube.com/watch?v=68jD0qKqp0k)

#### CSCI 3130

[Android 开发者指南](https://developer.android.com/guide/index.html)

[Android Asset Studio](http://romannurik.github.io/AndroidAssetStudio/)

[Android基础入门教程](https://www.runoob.com/w3cnote/android-tutorial-intro.html)

[在 Windows 上配置虚拟机加速](https://developer.android.com/studio/run/emulator-acceleration#vm-windows)

#### CSCI4145

[AWS 管理控制台](https://aws.amazon.com/cn/console/)

[Docker(三)：Dockerfile 命令详解](http://www.ityouknow.com/docker/2018/03/15/docker-dockerfile-command-introduction.html)

[12 - Dockerfile指令详解（Docker系列）](https://www.jianshu.com/p/ff301a3ecf17)

[在线 AWS 架构图软件](https://online.visual-paradigm.com/cn/diagrams/features/aws-architecture-diagram-tool/)
...
[sscanf的字符串格式化用法](https://www.cnblogs.com/clover-toeic/p/3727028.html)

#### CSCI 3110

[Vertex Cover Problem](https://www.geeksforgeeks.org/vertex-cover-problem-set-1-introduction-approximate-algorithm-2/)

[阿登定理](http://www.vue5.com/automata_theory/ardens_theorem.html)

[使用Myphill-Nerode定理的DFA最小化](http://www.vue5.com/automata_theory/dfa_minimization.html)

[哈夫曼编码问题再续（下篇）——优先队列求解](https://blog.csdn.net/liujian20150808/article/details/51017239)

[binarySearch()方法详解](https://blog.csdn.net/CXHPLY/article/details/49423501)

[动态规划之“最优二叉搜索树”](https://blog.csdn.net/cyp331203/article/details/43083647)

[最优二叉查找树（动态规划）](https://blog.csdn.net/xiajun07061225/article/details/8088784)
...
[OpenGL 1.1 Reference](http://www.talisman.org/opengl-1.1/Reference.html)  

[欢迎来到OpenGL的世界](https://learnopengl-cn.github.io/)

[CSCI 3161 Computer Animation](https://web.cs.dal.ca/~sbrooks/csci3161/index.html)  

[glutKeyboardUpFunc](https://www.dei.isep.ipp.pt/~matos/cg/docs/manual/glutKeyboardUpFunc.3GLUT.html)

#### Java

[评估编程技能的 30 个 Java 编码问题](https://www.techbeamers.com/java-coding-questions-assess-programming-skills/)

[IDEA开发工具Java零基础](https://ke.qq.com/course/363148)

#### Net & Database (CSCI 3171 , 2141, 3136)
...
[编译器设计中的语义分析](https://www.geeksforgeeks.org/semantic-analysis-in-compiler-design/)
